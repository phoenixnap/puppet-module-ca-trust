...
* RedHat & Derivatives: /etc/pki/ca-trust/source/anchors
...
```
ca_trust::pem::anchor { 'ca-cert.pem':
  ensure   => 'present',
...
Description: The location from which the specified anchor will be downloaded.  See [Puppet File Resource: source](https://puppet.com/docs/puppet/5.5/types/package.html) parameter documentation for more details.
